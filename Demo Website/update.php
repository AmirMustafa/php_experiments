<?php
	...
	$q = "update info set fn = '$fn',mn = '$mn', ln = '$ln', mobile = '$mob', gender = '$gender', city = '$city', img = '$img_dest', cv = '$cv_dest' where eml = '".$_SESSION['username']."'   ";
								//while setting fn = '$fn, the left element (i.e. fn is the name of the table structure in database which we have imported and right one is the retrieved data variable shown in beginning of the page)'
